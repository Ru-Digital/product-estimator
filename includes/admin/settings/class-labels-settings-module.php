    ...
    private function get_label_description($category, $label_key) {
        $descriptions = [
            'buttons' => [
                ...
                'delete' => 'Text for the generic delete button',
                'edit' => 'Text for the generic edit button',
                'add' => 'Text for the generic add button',
                'update' => 'Text for the update button when modifying records',
                'search' => 'Text for the search button in search interfaces',
                'filter' => 'Text for the filter button in filtering interfaces',
                'reset' => 'Text for the reset button to clear form inputs',
            ...
            'messages' => [
                ...
                'network_error' => 'Error message when network connection fails',
                'permission_denied' => 'Error message for insufficient permissions',
                'confirm_remove_product' => 'Confirmation message when removing products',
                'confirm_delete_room' => 'Confirmation message when deleting rooms',
                'unsaved_changes' => 'Warning message about unsaved changes',
                'min_length' => 'Validation error for minimum text length',
                'max_length' => 'Validation error for maximum text length',
                'invalid_format' => 'Validation error for incorrect format',
                'number_required' => 'Validation error requiring numeric input',
            ],
            'ui_elements' => [
                ...
                'no_results' => 'Message shown when search returns no results',
                'empty_room' => 'Message shown when a room has no products',
                'empty_estimate' => 'Message shown when an estimate has no rooms',
                'showing_results' => 'Text for search results count display',
                'page_of' => 'Text for pagination display',
                'sort_by' => 'Label for sorting dropdown',
                'filter_by' => 'Label for filtering dropdown',
                'search_results' => 'Heading for search results section',
                'no_items' => 'Message shown when a list has no items',
                'add_first_item' => 'Prompt for adding first item to empty list',
                'learn_more' => 'Text for information/help links',
                'view_all' => 'Text for link to view all items',
                'hide_all' => 'Text for link to hide all items',
            ],
            'pdf' => [
