...
// Plugin Constants
define('PRODUCT_ESTIMATOR_VERSION', '3.0.0'); // Consider updating this if making changes
...
// Note: Hierarchical labels are fully integrated via LabelsStructure class
// V3 hierarchical structure is the default implementation
...
function run_product_estimator() {
    // Set global plugin info for later use
    global $product_estimator_plugin_info;
    $product_estimator_plugin_info = [
