        ...
        if (room.products) {
          ...
          if ((0,_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2__["default"])(room.products) === 'object' && room.products[productIdStr] || Array.isArray(room.products) && room.products.find(function (product) {
            ...
            return Promise.reject({
              message: _utils__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.product_already_exists', 'This product already exists in the selected room.'),
              data: {
                duplicate: true,
...
/* harmony import */ var _CustomerStorage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CustomerStorage */ "./src/js/frontend/CustomerStorage.js");
/* harmony import */ var _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./TemplateEngine */ "./src/js/frontend/TemplateEngine.js");
/* harmony import */ var _utils_labels__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @utils/labels */ "./src/js/utils/labels.js");
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EstimateActions, [{
    ...
    value: function showCustomerDetailsPrompt(estimateId, button) {
      ...
      this.checkCustomerDetails(estimateId).then(function (customerInfo) {
        ...
        dialog.show({
          ...
          confirmText: _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('buttons.continue', 'Continue'),
          cancelText: _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('buttons.cancel', 'Cancel'),
          type: 'form',
    ...
    value: function getDialogInstruction(action, missingFields) {
      if (action === 'request_copy_email') {
        return _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.email_required_for_copy', 'An email address is required to send your estimate copy.');
      } else if (action === 'request_copy_sms') {
        return _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.phone_required_for_sms', 'A phone number is required to send your estimate via SMS.');
      } else if (action === 'request_contact_email') {
        return _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.contact_email_details_required', 'Your details are required for our store to contact you via email.');
      } else if (action === 'request_contact_phone') {
        return _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.contact_phone_details_required', 'Your details are required for our store to contact you via phone.');
      } else if (missingFields.includes('email') && !missingFields.includes('name')) {
        return _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.email_required_for_estimate', 'An email address is required to view your estimate.');
      }
      return _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.additional_information_required', 'Additional information is required to continue.');
    }
    ...
    value: function validateAndCollectFormData(missingFields, existingDetails) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (!value) {
            errorMessage = "".concat(this.getFieldLabel(field), " ").concat(_utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.required_field', 'is required'));
            isValid = false;
            break;
          }
          ...
          if (field === 'email' && !this.validateEmail(value)) {
            errorMessage = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.invalid_email', 'Please enter a valid email address');
            isValid = false;
            break;
          }
          if (field === 'phone' && !this.validatePhone(value)) {
            errorMessage = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.invalid_phone', 'Please enter a valid phone number');
            isValid = false;
            break;
          }
    ...
    value: function getDialogTitle(action) {
      ...
      var titles = {
        'print': _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.complete_details_title', 'Complete Your Details'),
        'request_copy_email': _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.email_details_required_title', 'Email Details Required'),
        'request_copy_sms': _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.phone_details_required_title', 'Phone Number Required'),
        'request_contact_email': _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.contact_information_required_title', 'Contact Information Required'),
        'request_contact_phone': _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.contact_information_required_title', 'Contact Information Required')
      };
      return titles[action] || _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.complete_details_title', 'Complete Your Details');
    }
    ...
    value: function getFieldLabel(field) {
      var labels = {
        'name': _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('forms.full_name', 'Full Name'),
        'email': _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('forms.email_address', 'Email Address'),
        'phone': _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('forms.phone_number', 'Phone Number')
      };
    ...
    value: function showContactSelectionPrompt(estimateId, button) {
      ...
      var title = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.contact_method_estimate_title', 'How would you like to receive your estimate?');
      var prompt = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.contact_method_estimate_prompt', 'Please choose how you\'d prefer to receive your estimate:');
      var emailBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('buttons.contact_email', 'Email');
      var phoneBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('buttons.contact_phone', 'SMS');
      if (action === 'request_contact') {
        title = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.contact_method_title', 'How would you like to be contacted?');
        prompt = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('messages.contact_method_prompt', 'Please choose how you\'d prefer our store to contact you:');
        emailBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('buttons.contact_email', 'Email');
        phoneBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('buttons.contact_phone', 'Phone');
      }
    ...
    value: function showMessage(message) {
      ...
      if (window.productEstimator && window.productEstimator.dialog) {
        window.productEstimator.dialog.show({
          title: _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('ui_elements.success_title', 'Success'),
          message: message,
          type: 'estimate',
          action: 'confirm',
          confirmText: _utils_labels__WEBPACK_IMPORTED_MODULE_6__.labelManager.get('buttons.ok', 'OK'),
          cancelText: null,
          onConfirm: function onConfirm() {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EstimateManager, [{
    ...
    value: function loadEstimatesData(formElement, productId) {
      ...
      this.dataService.getEstimatesData().then(function (estimates) {
        ...
        var defaultOptionText = _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('forms.select_estimate_option', '-- Select an Estimate --');
      ...
      if (!this.loadingIndicator) {
        ...
        if (this.modal) {
          ...
          _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].insert(loadingTemplateId, {
            loadingText: _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('ui_elements.loading', 'Loading...')
          }, loadingContainer);
          this.modal.appendChild(loadingContainer);
          this.loadingIndicator = loadingContainer;
        } else {
        ...
        if (error.primaryConflict === true) {
          ...
          if (_this2.modalManager && _this2.modalManager.confirmationDialog) {
            ...
            _this2.modalManager.confirmationDialog.show({
              ...
              type: 'product',
              action: 'replace',
              confirmText: _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('buttons.replace_existing_product', 'Replace the existing product'),
              cancelText: _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('buttons.go_back_to_room_select', 'Go back to room select'),
              additionalButtons: [{
...
var RoomManager = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(RoomManager, [{
    ...
    value: function loadRoomsForSelection(estimateId, formElement) {
      ...
      return this.dataService.getRoomsForEstimate(estimateId).then(function (response) {
        ...
        _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].insert('select-option-template', {
          value: '',
          text: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('forms.select_room_option', '-- Select a room --'),
              ...
              if (_this2.modalManager && _this2.modalManager.confirmationDialog) {
                setTimeout(function () {
                  _this2.modalManager.confirmationDialog.show({
                    ...
                    action: 'success',
                    showCancel: false,
                    confirmText: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('buttons.ok', 'OK')
                  });
              ...
              if (additionalProduct.is_variable && additionalProduct.variations) {
                ...
                sortedVariations.forEach(function (variation, index) {
                  ...
                  if (button) {
                    ...
                    button.textContent = variation.selected === true ? _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('buttons.selected_additional_product', 'Selected') : _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('buttons.select_additional_product', 'Select');
        ...
        button._clickHandler = function (e) {
          ...
          if (_this7.modalManager && _this7.modalManager.confirmationDialog) {
            _this7.modalManager.confirmationDialog.show({
              ...
              confirmText: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('buttons.remove', 'Remove'),
              cancelText: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('buttons.cancel', 'Cancel'),
              type: 'product',
              action: 'delete',
              onConfirm: function onConfirm() {
      ...
      try {
        ...
        if (formElement) {
          ...
          if (productId) {
            ...
            if (submitButton) {
              submitButton.textContent = _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('buttons.add_room_and_product', 'Add Room & Product');
            }
          } else {
            delete formElement.dataset.productId;
    ...
    value: function handleRoomRemoval(estimateId, roomId) {
      ...
      // Show the confirmation dialog using the dedicated component
      this.modalManager.confirmationDialog.show({
        title: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('ui_elements.remove_room_title', 'Remove Room'),
        message: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('ui_elements.remove_room_message', 'Are you sure you want to remove this room? All products in this room will also be removed. This action cannot be undone.'),
        confirmText: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('buttons.delete', 'Delete'),
        cancelText: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('buttons.cancel', 'Cancel'),
        type: 'room',
