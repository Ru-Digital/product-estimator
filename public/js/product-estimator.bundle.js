...
var EstimateActions = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EstimateActions, [{
    ...
    value: function showContactSelectionPrompt(estimateId, button) {
      ...
      var title = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('ui_elements.contact_method_estimate_title', 'How would you like to receive your estimate?');
      var prompt = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('messages.contact_method_estimate_prompt', 'Please choose how you\'d prefer to receive your estimate:');
      var emailBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('buttons.contact_email', 'Email');
      var phoneBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('buttons.contact_phone', 'SMS');
      if (action === 'request_contact') {
        title = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('ui_elements.contact_method_title', 'How would you like to be contacted?');
        prompt = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('messages.contact_method_prompt', 'Please choose how you\'d prefer our store to contact you:');
        emailBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('buttons.contact_email', 'Email');
        phoneBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('buttons.contact_phone', 'Phone');
      }
...
var EstimateManager = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EstimateManager, [{
    ...
    value: function handleEstimateRemoval(estimateId) {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_3__.showDeleteConfirmDialog)(this.modalManager, _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('messages.confirm_delete_estimate', 'Are you sure you want to delete this estimate?'), function () {
        ...
        _this8.dataService.removeEstimate(estimateId).then(function () {
          ...
          (0,_utils__WEBPACK_IMPORTED_MODULE_3__.showSuccessDialog)(_this8.modalManager, _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('messages.estimate_removed', 'This estimate has been removed successfully.'), 'estimate', function () {
...
/* harmony export */ });
// Module
var code = `<template id="product-selection-template"> <div class="pe-dialog-backdrop" style="display:none"> <div class="pe-dialog pe-product-selection-dialog"> <div class="pe-dialog-header"> <h3 class="pe-dialog-title" data-label="dialogs.titles.product_selection">Select Product Options</h3> <button class="pe-dialog-close" aria-label="Close" data-aria-label="common_ui.general_actions.buttons.close_button.label">&times;</button> </div> <div class="pe-dialog-body"> <div class="pe-dialog-product-name"></div> <div class="pe-dialog-variations"> <p class="pe-dialog-message" data-label="dialogs.messages.select_options">Please select your options below:</p> <div class="pe-variation-options"> </div> </div> </div> <div class="pe-dialog-footer"> <button class="pe-dialog-cancel" data-label="common_ui.general_actions.buttons.cancel_button.label">Cancel</button> <button class="pe-dialog-confirm" disabled="disabled" data-label="product_management.product_actions.buttons.add_to_room_button.label">Add to Estimate</button> </div> </div> </div> </template>`;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
