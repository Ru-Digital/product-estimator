...
var ConfirmationDialog = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ConfirmationDialog, [{
    ...
    value: function createDialogElements() {
      ...
      _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__["default"].processLabels(this.dialogContainer);
      ...
      if (messageEl) {
        ...
        if (settings.type === 'form' && settings.formFields) {
          ...
          var selectionContainer = _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__["default"].create('dialog-contact-selection-template', {
            message: settings.message || _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_contact_form.headings.contact_select_heading.label', 'How would you like to be contacted?'),
            emailButtonText: settings.emailButtonText || _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_contact_form.buttons.contact_email_button.label', 'Email'),
            phoneButtonText: settings.phoneButtonText || _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_contact_form.buttons.contact_phone_button.label', 'Phone')
          });
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EstimateActions, [{
    ...
    value: function showCustomerDetailsPrompt(estimateId, button) {
      ...
      this.checkCustomerDetails(estimateId).then(function (customerInfo) {
        ...
        dialog.show({
          title: _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.estimate_actions.default_heading.title', 'Contact Information Required'),
          message: instruction,
          ...
          cancelText: _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('common_ui.general_actions.buttons.cancel_button.label', 'Cancel'),
          type: 'form',
          ...
          onConfirm: function onConfirm() {
            ...
            (0,_CustomerStorage__WEBPACK_IMPORTED_MODULE_5__.saveCustomerDetails)(validationResult.details);
    ...
    value: function validateAndCollectFormData(missingFields, existingDetails) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (!value) {
            errorMessage = "".concat(this.getFieldLabel(field), " ").concat(_utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('messages.required_field', 'is required'));
            isValid = false;
            break;
          }
          ...
          if (field === 'email' && !this.validateEmail(value)) {
            errorMessage = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('messages.invalid_email', 'Please enter a valid email address');
            isValid = false;
            break;
          }
          if (field === 'phone' && !this.validatePhone(value)) {
            errorMessage = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('messages.invalid_phone', 'Please enter a valid phone number');
            isValid = false;
            break;
          }
    ...
    value: function getFieldLabel(field) {
      var labels = {
        'name': _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('customer_details.customer_details_form.fields.customer_name_field.label', 'Full Name'),
        'email': _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('customer_details.customer_details_form.fields.customer_email_field.label', 'Email Address'),
        'phone': _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('customer_details.customer_details_form.fields.customer_phone_field.label', 'Phone Number')
      };
    ...
    value: function showContactSelectionPrompt(estimateId, button) {
      ...
      var title = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_copy_form.headings.copy_select_heading.label', 'How would you like to receive your estimate?');
      var prompt = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_copy_form.messages.copy_select_message.text', 'Please choose how you\'d prefer to receive your estimate:');
      var emailBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_copy_form.buttons.contact_email_button.label', 'Email');
      var phoneBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_copy_form.buttons.contact_sms_button.label', 'SMS');
      if (action === 'request_contact') {
        title = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_contact_form.headings.contact_select_heading.label', 'How would you like to be contacted?');
        prompt = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_contact_form.messages.contact_select_message.text', 'Please choose how you\'d prefer our store to contact you:');
        emailBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_contact_form.buttons.contact_email_button.label', 'Email');
        phoneBtnText = _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('estimate_management.request_contact_form.buttons.contact_phone_button.label', 'Phone');
      }
    ...
    value: function checkCustomerDetails(estimateId) {
      return new Promise(function (resolve, _reject) {
        ...
        var storedDetails = (0,_CustomerStorage__WEBPACK_IMPORTED_MODULE_5__.loadCustomerDetails)();
    ...
    value: function updateCustomerDetails(estimateId, details) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        (0,_CustomerStorage__WEBPACK_IMPORTED_MODULE_5__.saveCustomerDetails)(details);
    ...
    value: function showMessage(message) {
      ...
      if (window.productEstimator && window.productEstimator.dialog) {
        window.productEstimator.dialog.show({
          title: _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('ui_elements.success_title', 'Success'),
          message: message,
          type: 'estimate',
          action: 'confirm',
...
/* harmony import */ var _core_EventBus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./core/EventBus */ "./src/js/frontend/core/EventBus.js");
...
/* harmony import */ var _managers_ModalManager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./managers/ModalManager */ "./src/js/frontend/managers/ModalManager.js");
/* harmony import */ var _VariationHandler__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./VariationHandler */ "./src/js/frontend/VariationHandler.js");
/* harmony import */ var _CustomerDetailsManager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./CustomerDetailsManager */ "./src/js/frontend/CustomerDetailsManager.js");
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(EstimatorCore, [{
    ...
    value: function init() {
      ...
      try {
        ...
        if (!this.dataService) {
          this.dataService = new _DataService__WEBPACK_IMPORTED_MODULE_4__["default"]({
            debug: this.config.debug
          });
        }
        ...
        var initializeComponents = function initializeComponents() {
          ...
          _this.modalManager = new _managers_ModalManager__WEBPACK_IMPORTED_MODULE_5__["default"]({
            debug: _this.config.debug,
            selectors: _this.config.selectors
          }, _this.dataService);

          // Initialize customer details manager
          _this.customerDetailsManager = new _CustomerDetailsManager__WEBPACK_IMPORTED_MODULE_7__["default"]({
            debug: _this.config.debug
          }, _this.dataService);
          ...
          if (_this.isWooCommerceProductPage()) {
            ...
            _this.variationHandler = new _VariationHandler__WEBPACK_IMPORTED_MODULE_6__["default"]({
              debug: _this.config.debug
            });
          }
          ...
          if (_this.config.debug) {
            _core_EventBus__WEBPACK_IMPORTED_MODULE_3__["default"].setDebug(true);
          }
    ...
    value: function on(event, callback) {
      ...
      _core_EventBus__WEBPACK_IMPORTED_MODULE_3__["default"].on(event, callback);
    ...
    value: function emit(event, data) {
      ...
      _core_EventBus__WEBPACK_IMPORTED_MODULE_3__["default"].emit(event, data);
    ...
    value: function processLabels() {
      ...
      if (this.prevBtn) {
        if (!this.prevBtn.getAttribute('aria-label')) {
          this.prevBtn.setAttribute('aria-label', _utils_labels__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('common_ui.general_actions.buttons.back_button.label', 'Previous'));
        }
      }
      if (this.nextBtn) {
        if (!this.nextBtn.getAttribute('aria-label')) {
          this.nextBtn.setAttribute('aria-label', _utils_labels__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('common_ui.general_actions.buttons.next_button.label', 'Next'));
        }
      }
    }
  }, {
...
var ProductSelectionDialog = /*#__PURE__*/function () {
  function ProductSelectionDialog(modalManager, templateEngine) {
    ...
    this.labels = {
      ...
      replaceProduct: _utils_labels__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('product_management.product_selection.buttons.replace_product_button.label', 'Replace Product'),
...
var TemplateEngine = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(TemplateEngine, [{
    ...
    value: function create(templateId) {
      ...
      if (!context) {
        try {
          ...
          var callerLine = stackLines.find(function (line) {
            return line.includes('.js:') && !line.includes('TemplateEngine.js');
          });
          if (callerLine) {
            // Extract file name from the line
            var match = callerLine.match(/\/([^/]+\.js):/);
    ...
    value: function insert(templateId, data, container) {
      ...
      var element = this.create(templateId, data, context); // element is a DocumentFragment
    ...
    value: function verifyTemplates() {
      var _this4 = this;
      var criticalTemplates = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      ...
      Object.keys(this.templates).forEach(function (templateId) {
        // Check if template HTML exists
        if (!_this4.templates[templateId] || _this4.templates[templateId].trim() === '') {
          logger.warn("Template \"".concat(templateId, "\" has empty HTML content"));
          results.empty.push(templateId);
        }

        // Check if template element was created
        if (!_this4.templateElements[templateId]) {
          logger.warn("Template element for \"".concat(templateId, "\" was not created"));
          results.missing.push(templateId);

          // Check if this is a critical template
          if (criticalTemplates.includes(templateId)) {
            logger.error("CRITICAL: Required template \"".concat(templateId, "\" is missing!"));
      ...
      if (results.critical.missing.length > 0) {
        logger.error('Critical templates are missing, application may not function correctly:', results.critical.missing);
      }
      logger.groupEnd();
      return results;
    }
    ...
    key: "trackTemplateUsage",
    value: function trackTemplateUsage(templateId) {
    ...
    key: "getTemplateUsageStats",
    value: function getTemplateUsageStats() {
      var _this5 = this;
      if (!this._templateUsage) {
        return {};
      }
      ...
      Object.keys(this._templateUsage).forEach(function (templateId) {
        usageStats[templateId] = Array.from(_this5._templateUsage[templateId]);
      });
      return usageStats;
    }
    ...
    key: "logTemplateUsage",
    value: function logTemplateUsage() {
      logger.group('Template Usage Statistics');
      var usageStats = this.getTemplateUsageStats();
      var templateIds = Object.keys(usageStats);
      if (templateIds.length === 0) {
        logger.log('No template usage data recorded');
        logger.groupEnd();
        return;
      }
      logger.log("Usage data for ".concat(templateIds.length, " templates:"));

      // For each template, show where it's used
      templateIds.forEach(function (templateId) {
        var contexts = usageStats[templateId];
        logger.log("- \"".concat(templateId, "\" used in: ").concat(contexts.join(', ')));
      });

      // Find unused templates
      var unusedTemplates = Object.keys(this.templates).filter(function (id) {
        return !usageStats[id];
      });
      if (unusedTemplates.length > 0) {
        logger.warn("Found ".concat(unusedTemplates.length, " potentially unused templates:"), unusedTemplates);
      }
      logger.groupEnd();
    }
  }]);
...
/***/ "./src/js/frontend/core/EventBus.js":
/*!******************************************!*\
  !*** ./src/js/frontend/core/EventBus.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var logger = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.createLogger)('EventBus');
var EventBus = /*#__PURE__*/function () {
  function EventBus() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, EventBus);
    this.events = {};
    this.debug = false;
  }
   ...
   */
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EventBus, [{
    key: "setDebug",
    ...
    value: function on(event, callback) {
      ...
      if (this.debug) {
        logger.log("Subscribed to event \"".concat(event, "\""), {
      ...
      return function () {
        _this.off(event, callback, context);
      };
    }
    ...
    value: function off(event, callback) {
      ...
      this.events[event] = this.events[event].filter(function (subscription) {
        return subscription.callback !== callback || context !== null && subscription.context !== context;
      });
      ...
      if (this.debug) {
        ...
        logger.log("Unsubscribed from event \"".concat(event, "\""), {
          remainingSubscribers: ((_this$events$event = this.events[event]) === null || _this$events$event === void 0 ? void 0 : _this$events$event.length) || 0
        });
      }
      return this;
    }
    ...
    value: function once(event, callback) {
      ...
      var _wrapper = function wrapper() {
        _this2.off(event, _wrapper, context);
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        return callback.apply(context || _this2, args);
      };

      // Store the original callback for potential manual unsubscription
      _wrapper.originalCallback = callback;
      return this.on(event, _wrapper, context);
    }
    ...
    value: function emit(event) {
      ...
      if (!this.events[event]) {
        if (this.debug) {
          logger.log("Event \"".concat(event, "\" emitted but has no subscribers"));
        }
        return this;
      }
      if (this.debug) {
        logger.log("Emitting event \"".concat(event, "\" to ").concat(this.events[event].length, " subscribers"), {
          args: args.length ? args : 'none'
        });
      }

      // Execute each callback with proper context and arguments
      this.events[event].forEach(function (subscription) {
        try {
          var callback = subscription.callback,
            context = subscription.context;
          callback.apply(context || _this3, args);
        } catch (error) {
          logger.error("Error in event handler for \"".concat(event, "\":"), error);
    ...
    value: function clear(event) {
      if (event) {
        delete this.events[event];
        if (this.debug) {
          logger.log("Cleared all handlers for event \"".concat(event, "\""));
        }
      } else {
        this.events = {};
        if (this.debug) {
    ...
    key: "subscriberCount",
    value: function subscriberCount(event) {
      var _this$events$event2;
      return ((_this$events$event2 = this.events[event]) === null || _this$events$event2 === void 0 ? void 0 : _this$events$event2.length) || 0;
    }
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EstimateManager, [{
    ...
    value: function showEstimateSelection(productId) {
      ...
      try {
        ...
        _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__["default"].processLabels(estimateSelectionWrapper);
    ...
    value: function loadEstimatesData(formElement, productId) {
      ...
      this.dataService.getEstimatesData().then(function (estimates) {
        ...
        var defaultOptionText = _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('estimate_management.estimate_selection_form.fields.estimate_choice_field.default_option', '-- Select an Estimate --');
        _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__["default"].insert('select-option-template', {
          value: '',
        ...
        if (estimates && estimates.length > 0) {
          estimates.forEach(function (estimate) {
            var optionText = estimate.name || "Estimate #".concat(estimate.id);
            _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__["default"].insert('select-option-template', {
              value: estimate.id,
              text: optionText
            }, selectElement);
          ...
          _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__["default"].insert('select-option-template', {
            value: '',
            text: _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('ui_elements.no_estimates_available', 'No estimates available'),
    ...
    value: function handleEstimateRemoval(estimateId) {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_3__.showDeleteConfirmDialog)(this.modalManager, _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('estimate_management.remove_estimate_dialog.message.text', 'Are you sure you want to delete this estimate?'), function () {
        ...
        _this8.dataService.removeEstimate(estimateId).then(function () {
          ...
          (0,_utils__WEBPACK_IMPORTED_MODULE_3__.showSuccessDialog)(_this8.modalManager, _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('estimate_management.estimated_removed_dialog.estimate_removed.text', 'This estimate has been removed successfully.'), 'estimate', function () {
...
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @utils */ "./src/js/utils/index.js");
/* harmony import */ var _core_EventBus__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../core/EventBus */ "./src/js/frontend/core/EventBus.js");
/* harmony import */ var _EstimateStorage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../EstimateStorage */ "./src/js/frontend/EstimateStorage.js");
/* harmony import */ var _CustomerStorage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../CustomerStorage */ "./src/js/frontend/CustomerStorage.js");
...
/* harmony import */ var _ConfirmationDialog__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../ConfirmationDialog */ "./src/js/frontend/ConfirmationDialog.js");
/* harmony import */ var _ProductSelectionDialog__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../ProductSelectionDialog */ "./src/js/frontend/ProductSelectionDialog.js");
/* harmony import */ var _Tooltip__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Tooltip */ "./src/js/frontend/Tooltip.js");
/* harmony import */ var _EstimateActions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../EstimateActions */ "./src/js/frontend/EstimateActions.js");
/* harmony import */ var _EstimateManager__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./EstimateManager */ "./src/js/frontend/managers/EstimateManager.js");
/* harmony import */ var _RoomManager__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./RoomManager */ "./src/js/frontend/managers/RoomManager.js");
/* harmony import */ var _ProductManager__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./ProductManager */ "./src/js/frontend/managers/ProductManager.js");
/* harmony import */ var _FormManager__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./FormManager */ "./src/js/frontend/managers/FormManager.js");
/* harmony import */ var _UIManager__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./UIManager */ "./src/js/frontend/managers/UIManager.js");
...
var ModalManager = /*#__PURE__*/function () {
  ...
  function ModalManager() {
    ...
    // Storage functions
    this.loadEstimateData = _EstimateStorage__WEBPACK_IMPORTED_MODULE_5__.loadEstimateData;
    this.saveEstimateData = _EstimateStorage__WEBPACK_IMPORTED_MODULE_5__.saveEstimateData;
    this.clearEstimateData = _EstimateStorage__WEBPACK_IMPORTED_MODULE_5__.clearEstimateData;
    this.loadCustomerDetails = _CustomerStorage__WEBPACK_IMPORTED_MODULE_6__.loadCustomerDetails;
    this.saveCustomerDetails = _CustomerStorage__WEBPACK_IMPORTED_MODULE_6__.saveCustomerDetails;
    this.clearCustomerDetails = _CustomerStorage__WEBPACK_IMPORTED_MODULE_6__.clearCustomerDetails;
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ModalManager, [{
    ...
    value: function init() {
      ...
      try {
        ...
        if (!this.modal) {
          ...
          this.modal = _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].createModalContainer();
          if (this.modal) {
    ...
    value: function initializeElements() {
      ...
      try {
        ...
        if (!this.loadingIndicator) {
          ...
          _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].insert('loading-placeholder-template', {
            loadingText: _utils__WEBPACK_IMPORTED_MODULE_3__.labelManager.get('ui.components.loading.general', 'Loading...')
          }, loadingContainer);
    ...
    value: function initializeManagers() {
      ...
      // and the dataService
      this.estimateManager = new _EstimateManager__WEBPACK_IMPORTED_MODULE_12__["default"](this.config, this.dataService, this);
      this.roomManager = new _RoomManager__WEBPACK_IMPORTED_MODULE_13__["default"](this.config, this.dataService, this);
      this.productManager = new _ProductManager__WEBPACK_IMPORTED_MODULE_14__["default"](this.config, this.dataService, this);
      this.formManager = new _FormManager__WEBPACK_IMPORTED_MODULE_15__["default"](this.config, this.dataService, this);
      this.uiManager = new _UIManager__WEBPACK_IMPORTED_MODULE_16__["default"](this.config, this.dataService, this);
      ...
      try {
        ...
        this.confirmationDialog = new _ConfirmationDialog__WEBPACK_IMPORTED_MODULE_8__["default"]();
      ...
      try {
        this.estimateActions = new _EstimateActions__WEBPACK_IMPORTED_MODULE_11__["default"]({
          debug: this.config.debug,
      ...
      try {
        this.productSelectionDialog = new _ProductSelectionDialog__WEBPACK_IMPORTED_MODULE_9__["default"](this, _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"]);
      ...
      try {
        this.tooltip = new _Tooltip__WEBPACK_IMPORTED_MODULE_10__["default"](_TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"]);
        this.tooltip.init();
    ...
    value: function showLoading() {
      ...
      if (!this.loadingIndicator) {
        ...
        if (this.modal) {
          ...
          var loadingTemplateId = 'loading-placeholder-template';
          var loadingContainer = document.createElement('div');
          loadingContainer.className = 'product-estimator-modal-loading';
      ...
      try {
        ...
        _core_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].emit('modal:loading:started', this.modal);
    ...
    value: function hideLoading() {
      ...
      try {
        ...
        _core_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].emit('modal:loading:ended', this.modal);
    ...
    value: function openModal() {
      ...
      _core_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].emit('modal:before:open', {
        productId: productId,
    ...
    value: function proceedWithModalOpen(productId, forceListView) {
      ...
      try {
        ...
        _core_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].emit('modal:opened', {
    ...
    value: function closeModal() {
      ...
      _core_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].emit('modal:before:close', this.modal);
      ...
      try {
        ...
        _core_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].emit('modal:closed', this.modal);

        // Also dispatch DOM event for backwards compatibility
        var domEvent = new CustomEvent('productEstimatorModalClosed');
    ...
    value: function showError(message) {
      try {
        ...
        if (this.modal && _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"]) {
          var formContainer = this.modal.querySelector('.product-estimator-modal-form-container');
          if (formContainer) {
            _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].showMessage(message, 'error', formContainer);
          } else {
    ...
    value: function ensureLoaderHidden() {
      ...
      try {
        ...
        _core_EventBus__WEBPACK_IMPORTED_MODULE_4__["default"].emit('modal:loading:safety', this.modal);
      ...
      this.dataService.updateProductVariation(estimateId, roomId, productIndex, variationId).then(function (result) {
        ...
        if (_this6.modalManager) {
          ...
          if (confirmationDialog) {
            confirmationDialog.show({
              title: _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('ui_elements.error_title', 'Error'),
              message: _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('messages.general_error', 'Error updating variation. Please try again.'),
              type: 'product',
              action: 'error',
              showCancel: false,
              confirmText: _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('common_ui.general_actions.buttons.ok_button.label', 'OK')
    ...
    value: function replaceProductInRoom(estimateId, roomId, oldProductId, newProductId) {
      ...
      this.dataService.replaceProductInRoom(estimateId, roomId, oldProductId, newProductId).then(function () {
        ...
        if (_this7.modalManager && _this7.modalManager.confirmationDialog) {
          _this7.modalManager.confirmationDialog.show({
            title: _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('ui_elements.error_title', 'Error'),
            message: _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('messages.general_error', 'Error replacing product. Please try again.'),
            type: 'product',
            action: 'error',
            showCancel: false,
            confirmText: _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('common_ui.general_actions.buttons.ok_button.label', 'OK')
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(RoomManager, [{
    ...
    value: function showRoomSelectionForm(estimateId) {
      ...
      this.dataService.getEstimate(estimateId).then(function (estimate) {
        ...
        try {
          ...
          _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].processLabels(roomSelectionForm);
    ...
    value: function loadRoomsForSelection(estimateId, formElement) {
      ...
      return this.dataService.getRoomsForEstimate(estimateId).then(function (response) {
        ...
        _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].insert('select-option-template', {
          value: '',
          text: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('room_management.room_selection_form.fields.room_choice_field.default_option', '-- Select a room --'),
        ...
        if (hasRooms && roomsArray.length > 0) {
          ...
          _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].insert('select-option-template', {
            value: '',
            text: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('ui_elements.no_rooms_available', 'No rooms available'),
        ...
        button._clickHandler = function (e) {
          ...
          if (_this7.modalManager && _this7.modalManager.confirmationDialog) {
            _this7.modalManager.confirmationDialog.show({
              ...
              confirmText: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('common_ui.general_actions.buttons.remove_button.label', 'Remove'),
      ...
      try {
        ...
        if (formElement) {
          ...
          if (productId) {
            ...
            if (submitButton) {
              submitButton.textContent = _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('room_management.add_new_room_form.buttons.add_product_and_room_button.label', 'Add Room & Product');
            }
          } else {
            delete formElement.dataset.productId;
            ...
            if (_this0.modalManager.productManager) {
                ...
                if (_this0.modalManager && _this0.modalManager.confirmationDialog) {
                  setTimeout(function () {
                    _this0.modalManager.confirmationDialog.show({
                      title: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('ui_elements.room_created_title', 'Room Created'),
                      message: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('messages.room_created_with_product', 'The room has been created and the product has been added.'),
                      type: 'room',
                      action: 'success',
                      showCancel: false,
                      confirmText: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('common_ui.general_actions.buttons.ok_button.label', 'OK')
              ...
              if (_this0.modalManager && _this0.modalManager.confirmationDialog) {
                setTimeout(function () {
                  _this0.modalManager.confirmationDialog.show({
                    title: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('ui_elements.room_created_title', 'Room Created'),
                    message: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('messages.room_created', 'The room has been created.'),
                    type: 'room',
                    action: 'success',
                    showCancel: false,
                    confirmText: _utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('common_ui.general_actions.buttons.ok_button.label', 'OK')
    ...
    value: function handleRoomRemoval(estimateId, roomId) {
      ...
      if (!this.modalManager || !this.modalManager.confirmationDialog) {
        ...
        if (confirm(_utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('ui_elements.remove_room_message', 'Are you sure you want to remove this room? All products in this room will also be removed. This action cannot be undone.'))) {
    ...
    value: function performRoomRemoval(estimateId, roomId) {
      ...
      this.dataService.removeRoom(estimateId, roomId).then(function () {
        ...
        if (_this10.modalManager && _this10.modalManager.confirmationDialog) {
          ...
          // Fallback to modalManager.showError
          _this10.modalManager.showError(_utils__WEBPACK_IMPORTED_MODULE_5__.labelManager.get('messages.general_error', 'Error removing room. Please try again.'));
        }
        _this10.modalManager.hideLoading();
      });
    }
    ...
    value: function toggleSuggestions(toggleButton) {
      ...
      if (isExpanded) {
        ...
        _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__["default"].insert('toggle-button-show-template', {
          buttonText: i18n.showSuggestions || _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('buttons.show_suggestions', 'Show Suggestions')
        }, toggleButton);
        logger.log('Suggestions hidden');
      } else {
        // Show suggestions
        ...
        _TemplateEngine__WEBPACK_IMPORTED_MODULE_5__["default"].insert('toggle-button-hide-template', {
          buttonText: _i18n.hideSuggestions || _utils__WEBPACK_IMPORTED_MODULE_2__.labelManager.get('buttons.hide_suggestions', 'Hide Suggestions')
        }, toggleButton);
...
/* harmony export */ });
// Module
var code = `<template id="loading-placeholder-template"> <div class="loading-spinner"></div> <div class="loading-text" data-label="ui.components.loading.general">{{loadingText}}</div> </template>`;
// Exports
...
/* harmony export */ });
// Module
var code = `<template id="toggle-button-hide-template"> <span data-label="ui.components.toggles.hide_details">{{buttonText}}</span> <span class="toggle-icon dashicons dashicons-arrow-up-alt2"></span> </template>`;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="toggle-button-show-template"> <span data-label="ui.components.toggles.show_details">{{buttonText}}</span> <span class="toggle-icon dashicons dashicons-arrow-down-alt2"></span> </template>`;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="estimate-selection-template"> <div id="estimate-selection-wrapper"> <div id="estimate-selection-form-wrapper"> <h2 data-label="estimate_management.estimate_selection_form.heading.title">Select an Estimate</h2> <form id="estimate-selection-form"> <div class="form-group"> <label for="estimate-dropdown" data-label="estimate_management.estimate_selection_form.fields.estimate_choice_field.label">Choose an estimate:</label> <select id="estimate-dropdown" name="estimate_id" required> </select> </div> <div class="form-actions"> <button type="submit" class="button submit-btn" data-label="common_ui.general_actions.buttons.continue_button.label">Continue</button> <button type="button" class="button cancel-btn" id="create-estimate-btn" data-label="estimate_management.create_new_estimate_form.buttons.create_button.label"> Create New Estimate </button> </div> </form> </div> <div id="room-selection-form-wrapper" style="display:none"> <h2 data-label="room_management.room_selection_form.heading.title">Select a Room</h2> <form id="room-selection-form"> <div class="form-group"> <label for="room-dropdown" data-label="room_management.room_selection_form.fields.room_choice_field.label">Choose a room:</label> <select id="room-dropdown" name="room_id" required> </select> </div> <div class="form-actions"> <button type="submit" class="button submit-btn" data-label="product_management.product_actions.buttons.add_to_room_button.label">Add Product to Room</button> <button type="button" class="button cancel-btn back-btn" data-target="estimate-selection" data-label="common_ui.general_actions.buttons.back_button.label">Back</button> <button type="button" class="button add-room" id="add-new-room-from-selection" data-estimate="" data-label="room_management.room_selection_form.buttons.create_new_room_button.label">Add New Room</button> </div> </form> </div> </div> </template> `;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="new-estimate-form-template"> <div id="new-estimate-form-wrapper"> <h2 data-label="estimate_management.create_new_estimate_form.heading.title">Create New Estimate</h2> <form id="new-estimate-form" method="post" data-has-email="false"> <div class="form-group"> <label for="estimate-name" data-label="estimate_management.create_new_estimate_form.fields.estimate_name_field.label">Estimate Name</label> <input type="text" id="estimate-name" name="estimate_name" data-placeholder-label="estimate_management.create_new_estimate_form.fields.estimate_name_field.placeholder" placeholder="e.g. Home Renovation" required> </div> <div class="customer-details-section"> <h4 data-label="customer_details.customer_details_form.heading.title">Your Details</h4> <div class="form-group"> <label for="customer-postcode" data-label="customer_details.customer_details_form.fields.customer_postcode_field.label">Postcode</label> <input type="text" id="customer-postcode" name="customer_postcode" data-placeholder-label="customer_details.customer_details_form.fields.customer_postcode_field.placeholder" placeholder="Your postcode" required> </div> </div> <div class="button-group"> <button type="submit" class="submit-btn create-estimate-btn" data-label="estimate_management.create_new_estimate_form.buttons.create_button.label">Create Estimate</button> <button type="button" class="cancel-btn" data-form-type="estimate" data-label="common_ui.general_actions.buttons.cancel_button.label">Cancel</button> </div> </form> <div class="customer-details-display" style="display:none"> <div class="customer-details-header"> <h4 data-label="customer_details.customer_details_form.heading.title">Your Saved Details</h4> <div class="customer-details-actions"> <button type="button" class="edit-customer-details" id="edit-customer-details-btn" data-label="common_ui.general_actions.buttons.save_button.label">Edit</button> </div> </div> <div class="customer-details-content saved-customer-details"> </div> <div class="customer-details-edit-form" style="display:none"> <h4 data-label="customer_details.customer_details_form.heading.title">Edit Your Details</h4> <form id="customer-details-edit-form"> <div class="form-group"> <label for="edit-customer-name" data-label="customer_details.customer_details_form.fields.customer_name_field.label">Name</label> <input type="text" id="edit-customer-name" name="customer_name" data-placeholder-label="customer_details.customer_details_form.fields.customer_name_field.placeholder" placeholder="Your name"> </div> <div class="form-group"> <label for="edit-customer-email" data-label="customer_details.customer_details_form.fields.customer_email_field.label">Email</label> <input type="email" id="edit-customer-email" name="customer_email" data-placeholder-label="customer_details.customer_details_form.fields.customer_email_field.placeholder" placeholder="Your email"> </div> <div class="form-group"> <label for="edit-customer-phone" data-label="customer_details.customer_details_form.fields.customer_phone_field.label">Phone</label> <input type="tel" id="edit-customer-phone" name="customer_phone" data-placeholder-label="customer_details.customer_details_form.fields.customer_phone_field.placeholder" placeholder="Your phone"> </div> <div class="form-group"> <label for="edit-customer-postcode" data-label="customer_details.customer_details_form.fields.customer_postcode_field.label">Postcode</label> <input type="text" id="edit-customer-postcode" name="customer_postcode" data-placeholder-label="customer_details.customer_details_form.fields.customer_postcode_field.placeholder" placeholder="Your postcode"> </div> <div class="customer-details-edit-actions"> <button type="button" class="save-customer-details" id="save-customer-details-btn" data-label="common_ui.general_actions.buttons.save_button.label">Save Changes</button> <button type="button" class="cancel-edit-customer-details" id="cancel-edit-customer-details-btn" data-label="common_ui.general_actions.buttons.cancel_button.label">Cancel</button> </div> </form> </div> </div> </div> </template>`;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="new-room-form-template"> <div id="new-room-form-wrapper"> <h2 data-label="room_management.room_selection_form.buttons.create_new_room_button.label">Add New Room</h2> <form id="new-room-form" method="post" data-estimate-id="" data-product-id=""> <div class="form-group"> <label for="room-name" data-label="room_management.add_new_room_form.fields.room_name_field.label">Room Name</label> <input type="text" id="room-name" name="room_name" data-placeholder-label="room_management.add_new_room_form.fields.room_name_field.placeholder" placeholder="e.g. Living Room" required> </div> <div class="inline-group"> <div class="form-group"> <label for="room-width" data-label="room_management.add_new_room_form.fields.room_width_field.label">Width (m)</label> <input type="number" id="room-width" name="room_width" data-placeholder-label="room_management.add_new_room_form.fields.room_width_field.placeholder" placeholder="Width" required step="0.01" min="0.1"> </div> <div class="form-group"> <label for="room-length" data-label="room_management.add_new_room_form.fields.room_length_field.label">Length (m)</label> <input type="number" id="room-length" name="room_length" data-placeholder-label="room_management.add_new_room_form.fields.room_length_field.placeholder" placeholder="Length" required step="0.01" min="0.1"> </div> </div> <div class="button-group"> <button type="submit" class="submit-btn" data-label="room_management.add_new_room_form.buttons.add_button.label">Add Room</button> <button type="button" class="cancel-btn" data-form-type="room" data-label="common_ui.general_actions.buttons.cancel_button.label">Cancel</button> </div> </form> </div> </template> `;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="product-selection-template"> <div class="pe-dialog-backdrop" style="display:none"> <div class="pe-dialog pe-product-selection-dialog"> <div class="pe-dialog-header"> <h3 class="pe-dialog-title" data-label="product_management.product_selection.title.text">Select Product Options</h3> <button class="pe-dialog-close" aria-label="Close" data-aria-label="common_ui.general_actions.buttons.close_button.label">&times;</button> </div> <div class="pe-dialog-body"> <div class="pe-dialog-product-name"></div> <div class="pe-dialog-variations"> <p class="pe-dialog-message" data-label="product_management.product_selection.messages.select_options_message.text">Please select your options below:</p> <div class="pe-variation-options"> </div> </div> </div> <div class="pe-dialog-footer"> <button class="pe-dialog-cancel" data-label="common_ui.general_actions.buttons.cancel_button.label">Cancel</button> <button class="pe-dialog-confirm" disabled="disabled" data-label="product_management.product_actions.buttons.add_to_room_button.label">Add to Estimate</button> </div> </div> </div> </template> `;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="estimates-empty-template"> <div class="no-estimates"> <p data-label="estimate_management.empty_states.no_estimates_message.text">You don't have any estimates yet.</p> <button id="create-estimate-btn" class="button" data-label="estimate_management.create_new_estimate_form.buttons.create_button.label">Create New Estimate</button> </div> </template>`;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="products-empty-template"> <div class="products"> <p data-label="product_management.empty_states.no_products_message.text">You don't have any products in this room.</p> </div> </template>`;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="rooms-empty-template"> <div class="no-rooms"> <p data-label="room_management.empty_states.no_rooms_message.text">You don't have any rooms in this estimate.</p> </div> </template>`;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
