...
var EstimateActions = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EstimateActions, [{
    ...
    value: function showCustomerDetailsPrompt(estimateId, button) {
      ...
      this.checkCustomerDetails(estimateId).then(function (customerInfo) {
        ...
        dialog.show({
          ...
          confirmText: _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('buttons.continue', 'Continue'),
          cancelText: _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('buttons.cancel', 'Cancel'),
          type: 'form',
    ...
    value: function getFieldLabel(field) {
      var labels = {
        'name': _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('forms.full_name', 'Full Name'),
        'email': _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('forms.email_address', 'Email Address'),
        'phone': _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('forms.phone_number', 'Phone Number')
      };
    ...
    value: function showMessage(message) {
      ...
      if (window.productEstimator && window.productEstimator.dialog) {
        window.productEstimator.dialog.show({
          ...
          type: 'estimate',
          action: 'confirm',
          confirmText: _utils_labels__WEBPACK_IMPORTED_MODULE_4__.labelManager.get('buttons.ok', 'OK'),
          cancelText: null,
          onConfirm: function onConfirm() {
