...
/* harmony import */ var _PrintEstimate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./PrintEstimate */ "./src/js/frontend/PrintEstimate.js");
/* harmony import */ var _template_loader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./template-loader */ "./src/js/frontend/template-loader.js");
/* harmony import */ var _ProductDetailsToggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ProductDetailsToggle */ "./src/js/frontend/ProductDetailsToggle.js");
/**
 * index.js
 *
...
(0,_template_loader__WEBPACK_IMPORTED_MODULE_4__.initializeTemplates)();
...
function initEstimator(debugMode) {
  try {
    ...
    window.productEstimator.printEstimate = new _PrintEstimate__WEBPACK_IMPORTED_MODULE_3__["default"]({
      debug: debugMode
    }, dataServiceInstance);

    // Make ProductDetailsToggle available globally
    window.productEstimator.detailsToggle = _ProductDetailsToggle__WEBPACK_IMPORTED_MODULE_5__["default"]; // Add toggle module to global object
    ...
    document.addEventListener('click', function (e) {
      ...
      if (e.target.closest('.accordion-header')) {
        ...
        setTimeout(function () {
          ...
          if (_ProductDetailsToggle__WEBPACK_IMPORTED_MODULE_5__["default"] && typeof _ProductDetailsToggle__WEBPACK_IMPORTED_MODULE_5__["default"].setup === 'function') {
            logger.log('Accordion clicked, reinitializing product details toggle');
            _ProductDetailsToggle__WEBPACK_IMPORTED_MODULE_5__["default"].setup();
          }
...
/* harmony import */ var _EstimateManager__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./EstimateManager */ "./src/js/frontend/managers/EstimateManager.js");
/* harmony import */ var _RoomManager__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./RoomManager */ "./src/js/frontend/managers/RoomManager.js");
/* harmony import */ var _ProductManager__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ProductManager */ "./src/js/frontend/managers/ProductManager.js");
/* harmony import */ var _FormManager__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./FormManager */ "./src/js/frontend/managers/FormManager.js");
/* harmony import */ var _UIManager__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./UIManager */ "./src/js/frontend/managers/UIManager.js");
...
var ModalManager = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ModalManager, [{
    ...
    value: function initializeManagers() {
      ...
      // and the dataService
      this.estimateManager = new _EstimateManager__WEBPACK_IMPORTED_MODULE_10__["default"](this.config, this.dataService, this);
      this.roomManager = new _RoomManager__WEBPACK_IMPORTED_MODULE_11__["default"](this.config, this.dataService, this);
      this.productManager = new _ProductManager__WEBPACK_IMPORTED_MODULE_12__["default"](this.config, this.dataService, this);
      this.formManager = new _FormManager__WEBPACK_IMPORTED_MODULE_13__["default"](this.config, this.dataService, this);
      this.uiManager = new _UIManager__WEBPACK_IMPORTED_MODULE_14__["default"](this.config, this.dataService, this);
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(RoomManager, [{
    ...
    value: function bindAdditionalProductButtons(container) {
      ...
      buttons.forEach(function (button) {
        ...
        button._clickHandler = function (e) {
          ...
          _this4.selectProductAdditionVariation(estimateId, roomId, parentProductId, productId);
        };
    ...
    value: function selectProductAdditionVariation(estimateId, roomId, parentProductId, variationId) {
      ...
      this.dataService.updateProductAdditionVariation(estimateId, roomId, parentProductId, variationId).then(function () {
        ...
        _this5.updateProductAdditionVariationUI(estimateId, roomId);
      })["catch"](function (error) {
        logger.error('Error updating product addition variation', error);
    ...
    value: function bindIncludeItemRemoveButtons(includesContainer, estimateId, roomId) {
      ...
      removeButtons.forEach(function (button) {
        ...
        button._clickHandler = function (e) {
          ...
          if (_this6.modalManager && _this6.modalManager.confirmationDialog) {
            _this6.modalManager.confirmationDialog.show({
              ...
              onConfirm: function onConfirm() {
                ...
                if (_this6.modalManager.productManager) {
                  // Since products are indexed by ID, we need to pass the productId directly
                  _this6.modalManager.productManager.performProductRemoval(estimateId, roomId, null, productId);
                }
              },
              onCancel: function onCancel() {
                logger.log('Product removal cancelled by user');
          ...
          if (upgradeSection.products && Array.isArray(upgradeSection.products)) {
            upgradeSection.products.forEach(function (upgrade) {
              var upgradeData = {
                ...
                product_price: _utils__WEBPACK_IMPORTED_MODULE_5__.format.currency(upgrade.min_total || upgrade.price || 0),
                image: upgrade.image || '',
                url: upgrade.url || '#',
                parent_product_name: upgrade.parent_product_name
              };
              logger.log('Rendering upgrade product:', upgradeData);
              _TemplateEngine__WEBPACK_IMPORTED_MODULE_7__["default"].insert('product-upgrade-item-template', upgradeData, tilesWrapper);
            });
          }
      ...
      upgradeButtons.forEach(function (button) {
        ...
        button._clickHandler = function (e) {
          ...
          if (_this7.modalManager.productManager) {
            ...
            _this7.modalManager.productManager.replaceProductInRoom(estimateId, roomId, replaceProductId,
    ...
    value: function updateRoomIncludes(estimateId, roomId) {
      var _estimateData$estimat2, _estimate$rooms2;
      ...
      var isFirstProduct = room.products && Object.keys(room.products).length === 1;
    ...
    value: function initializeSimilarProductsForRoom(estimateId, roomId) {
      ...
      if (!roomElement) {
        ...
        setTimeout(function () {
          _this11.initializeSimilarProductsForRoom(estimateId, roomId, forceRefresh);
        }, 100);
        return;
      }
...
/* harmony import */ var _templates_components_product_upgrade_item_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @templates/components/product/upgrade-item.html */ "./src/templates/components/product/upgrade-item.html");
/* harmony import */ var _templates_components_product_additional_product_option_html__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @templates/components/product/additional-product-option.html */ "./src/templates/components/product/additional-product-option.html");
/* harmony import */ var _templates_components_product_additional_products_section_html__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @templates/components/product/additional-products-section.html */ "./src/templates/components/product/additional-products-section.html");
/* harmony import */ var _templates_components_product_similar_item_html__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @templates/components/product/similar-item.html */ "./src/templates/components/product/similar-item.html");
/* harmony import */ var _templates_components_product_suggestion_item_html__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @templates/components/product/suggestion-item.html */ "./src/templates/components/product/suggestion-item.html");
/* harmony import */ var _templates_components_room_room_item_html__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @templates/components/room/room-item.html */ "./src/templates/components/room/room-item.html");
/* harmony import */ var _templates_components_room_rooms_container_html__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @templates/components/room/rooms-container.html */ "./src/templates/components/room/rooms-container.html");
/* harmony import */ var _templates_components_room_actions_footer_html__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @templates/components/room/actions-footer.html */ "./src/templates/components/room/actions-footer.html");
/* harmony import */ var _templates_components_estimate_estimate_item_html__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @templates/components/estimate/estimate-item.html */ "./src/templates/components/estimate/estimate-item.html");
/* harmony import */ var _templates_components_common_loading_html__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @templates/components/common/loading.html */ "./src/templates/components/common/loading.html");
/* harmony import */ var _templates_components_common_select_option_html__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @templates/components/common/select-option.html */ "./src/templates/components/common/select-option.html");
/* harmony import */ var _templates_components_common_toggle_hide_html__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @templates/components/common/toggle/hide.html */ "./src/templates/components/common/toggle/hide.html");
/* harmony import */ var _templates_components_common_toggle_show_html__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @templates/components/common/toggle/show.html */ "./src/templates/components/common/toggle/show.html");
/* harmony import */ var _templates_forms_estimate_new_estimate_html__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @templates/forms/estimate/new-estimate.html */ "./src/templates/forms/estimate/new-estimate.html");
/* harmony import */ var _templates_forms_estimate_estimate_selection_html__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @templates/forms/estimate/estimate-selection.html */ "./src/templates/forms/estimate/estimate-selection.html");
/* harmony import */ var _templates_forms_room_new_room_html__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @templates/forms/room/new-room.html */ "./src/templates/forms/room/new-room.html");
/* harmony import */ var _templates_forms_room_room_selection_html__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @templates/forms/room/room-selection.html */ "./src/templates/forms/room/room-selection.html");
/* harmony import */ var _templates_layout_modal_container_html__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @templates/layout/modal-container.html */ "./src/templates/layout/modal-container.html");
/* harmony import */ var _templates_ui_dialogs_confirmation_html__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @templates/ui/dialogs/confirmation.html */ "./src/templates/ui/dialogs/confirmation.html");
/* harmony import */ var _templates_ui_dialogs_product_selection_html__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @templates/ui/dialogs/product-selection.html */ "./src/templates/ui/dialogs/product-selection.html");
/* harmony import */ var _templates_ui_dialogs_variation_option_html__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @templates/ui/dialogs/variation-option.html */ "./src/templates/ui/dialogs/variation-option.html");
/* harmony import */ var _templates_ui_dialogs_variation_swatch_html__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @templates/ui/dialogs/variation-swatch.html */ "./src/templates/ui/dialogs/variation-swatch.html");
/* harmony import */ var _templates_ui_empty_states_estimates_empty_html__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @templates/ui/empty-states/estimates-empty.html */ "./src/templates/ui/empty-states/estimates-empty.html");
/* harmony import */ var _templates_ui_empty_states_rooms_empty_html__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @templates/ui/empty-states/rooms-empty.html */ "./src/templates/ui/empty-states/rooms-empty.html");
/* harmony import */ var _templates_ui_empty_states_products_empty_html__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! @templates/ui/empty-states/products-empty.html */ "./src/templates/ui/empty-states/products-empty.html");
/* harmony import */ var _templates_ui_errors_room_error_html__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! @templates/ui/errors/room-error.html */ "./src/templates/ui/errors/room-error.html");
/* harmony import */ var _templates_ui_errors_product_error_html__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! @templates/ui/errors/product-error.html */ "./src/templates/ui/errors/product-error.html");
/* harmony import */ var _templates_ui_errors_form_error_html__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! @templates/ui/errors/form-error.html */ "./src/templates/ui/errors/form-error.html");
/* harmony import */ var _templates_ui_messages_modal_messages_html__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! @templates/ui/messages/modal-messages.html */ "./src/templates/ui/messages/modal-messages.html");
/* harmony import */ var _templates_ui_tooltip_html__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! @templates/ui/tooltip.html */ "./src/templates/ui/tooltip.html");
/* harmony import */ var _templates_ui_tooltip_rich_html__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @templates/ui/tooltip-rich.html */ "./src/templates/ui/tooltip-rich.html");
/* harmony import */ var _TemplateEngine__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./TemplateEngine */ "./src/js/frontend/TemplateEngine.js");
...
var templates = {
  'room-item-template': _templates_components_room_room_item_html__WEBPACK_IMPORTED_MODULE_9__["default"],
  'estimate-item-template': _templates_components_estimate_estimate_item_html__WEBPACK_IMPORTED_MODULE_12__["default"],
  'suggestion-item-template': _templates_components_product_suggestion_item_html__WEBPACK_IMPORTED_MODULE_8__["default"],
  ...
  'similar-product-item-template': _templates_components_product_similar_item_html__WEBPACK_IMPORTED_MODULE_7__["default"],
  'product-upgrade-item-template': _templates_components_product_upgrade_item_html__WEBPACK_IMPORTED_MODULE_4__["default"],
  'additional-product-option-template': _templates_components_product_additional_product_option_html__WEBPACK_IMPORTED_MODULE_5__["default"],
  'additional-products-section-template': _templates_components_product_additional_products_section_html__WEBPACK_IMPORTED_MODULE_6__["default"],
  'select-option-template': _templates_components_common_select_option_html__WEBPACK_IMPORTED_MODULE_14__["default"],
  'loading-placeholder-template': _templates_components_common_loading_html__WEBPACK_IMPORTED_MODULE_13__["default"],
  'room-actions-footer-template': _templates_components_room_actions_footer_html__WEBPACK_IMPORTED_MODULE_11__["default"],
  'rooms-container-template': _templates_components_room_rooms_container_html__WEBPACK_IMPORTED_MODULE_10__["default"],
  'new-estimate-form-template': _templates_forms_estimate_new_estimate_html__WEBPACK_IMPORTED_MODULE_17__["default"],
  'new-room-form-template': _templates_forms_room_new_room_html__WEBPACK_IMPORTED_MODULE_19__["default"],
  'room-selection-form-template': _templates_forms_room_room_selection_html__WEBPACK_IMPORTED_MODULE_20__["default"],
  'estimate-selection-template': _templates_forms_estimate_estimate_selection_html__WEBPACK_IMPORTED_MODULE_18__["default"],
  'estimates-empty-template': _templates_ui_empty_states_estimates_empty_html__WEBPACK_IMPORTED_MODULE_26__["default"],
  'rooms-empty-template': _templates_ui_empty_states_rooms_empty_html__WEBPACK_IMPORTED_MODULE_27__["default"],
  'products-empty-template': _templates_ui_empty_states_products_empty_html__WEBPACK_IMPORTED_MODULE_28__["default"],
  'room-error-template': _templates_ui_errors_room_error_html__WEBPACK_IMPORTED_MODULE_29__["default"],
  'product-error-template': _templates_ui_errors_product_error_html__WEBPACK_IMPORTED_MODULE_30__["default"],
  'form-error-template': _templates_ui_errors_form_error_html__WEBPACK_IMPORTED_MODULE_31__["default"],
  'modal-messages-template': _templates_ui_messages_modal_messages_html__WEBPACK_IMPORTED_MODULE_32__["default"],
  'modal-container-template': _templates_layout_modal_container_html__WEBPACK_IMPORTED_MODULE_21__["default"],
  'confirmation-dialog-template': _templates_ui_dialogs_confirmation_html__WEBPACK_IMPORTED_MODULE_22__["default"],
  'product-selection-template': _templates_ui_dialogs_product_selection_html__WEBPACK_IMPORTED_MODULE_23__["default"],
  'variation-option-template': _templates_ui_dialogs_variation_option_html__WEBPACK_IMPORTED_MODULE_24__["default"],
  'variation-swatch-template': _templates_ui_dialogs_variation_swatch_html__WEBPACK_IMPORTED_MODULE_25__["default"],
  'toggle-button-hide-template': _templates_components_common_toggle_hide_html__WEBPACK_IMPORTED_MODULE_15__["default"],
  'toggle-button-show-template': _templates_components_common_toggle_show_html__WEBPACK_IMPORTED_MODULE_16__["default"],
  'tooltip': _templates_ui_tooltip_html__WEBPACK_IMPORTED_MODULE_33__["default"],
  'tooltip-rich': _templates_ui_tooltip_rich_html__WEBPACK_IMPORTED_MODULE_34__["default"]
};
...
function initializeTemplates() {
  ...
  Object.entries(templates).forEach(function (_ref) {
    ...
    if (!html || html.trim() === '') {
      ...
      _TemplateEngine__WEBPACK_IMPORTED_MODULE_35__["default"].registerTemplate(id, html);
    }
  });
  logger.log("Initialized template engine with ".concat(Object.keys(templates).length, " templates"));
  logger.groupEnd();
  return _TemplateEngine__WEBPACK_IMPORTED_MODULE_35__["default"];
}
...
var ___HTML_LOADER_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw== */ "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="), __webpack_require__.b);
// Module
var code = `<template id="room-item-template"> <div class="accordion-item room-item" data-room-id="" data-estimate-id=""> <div class="accordion-header-wrapper"> <div class="accordion-header room-item-header"> <div class="room-image-wrapper"> <img class="primary-product-image product-thumbnail" src="${___HTML_LOADER_IMPORT_0___}" alt="Primary product" data-visible-if="has_primary_product"> </div> <div class="room-details-wrapper"> <div class="room-details"> <div class="room-name-wrapper"> <span class="room-name"></span> <span class="primary-product-name"></span> <span class="room-dimensions"></span> </div> <div class="room-price"></div> </div> <div class="price-graph-container"> <div class="price-graph-bar"> <div class="price-graph-range"></div> </div> <div class="price-graph-labels"></div> </div> </div> <div class="room-actions"> <button class="remove-room" data-estimate-id="" data-room-id="" title="Remove Room"> <span class="dashicons dashicons-trash"></span> </button> </div> </div> </div> <div class="accordion-content"> <div class="room-empty-state" style="display:none"></div> <button class="product-includes-toggle expanded"> <span>Product Includes</span> <span class="toggle-icon dashicons dashicons-arrow-up-alt2"></span> </button> <div class="includes-container visible"> <div class="product-includes"> <div class="product-includes-items"></div> </div> <div class="price-notice">Prices are subject to check measures without notice</div> <div class="additional-products-container" style="display:none"> <div class="additional-products-list"> </div> </div> <div class="product-upgrades-container" style="display:none"> <div class="product-upgrades-list"> </div> </div> </div> <button class="product-details-toggle similar-products-toggle expanded"> <span>Similar Products</span> <span class="toggle-icon dashicons dashicons-arrow-up-alt2"></span> </button> <div class="similar-products-container visible" data-room-id=""> <div class="product-similar-products"> <div class="suggestions-carousel similar-products-carousel"> <div class="suggestions-nav prev" aria-label="Previous"> <span class="dashicons dashicons-arrow-left-alt2"></span> </div> <div class="suggestions-container similar-products-list"> </div> <div class="suggestions-nav next" aria-label="Next"> <span class="dashicons dashicons-arrow-right-alt2"></span> </div> </div> </div> </div> <div class="product-suggestions" style="display:none"> <button class="product-suggestions-toggle"> Suggested Products <span class="toggle-icon dashicons dashicons-arrow-down-alt2"></span></button> <div class="suggestions-container-wrapper"> <div class="suggestions-carousel"> <div class="suggestions-nav prev" aria-label="Previous Suggestions">&#10094;</div> <div class="suggestions-container"> </div> <div class="suggestions-nav next" aria-label="Next Suggestions">&#10095;</div> </div> </div> </div> </div> </div> </template> `;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
...
/* harmony export */ });
// Module
var code = `<template id="tooltip-rich-template"> <div class="pe-tooltip pe-tooltip-rich" role="tooltip"> <div class="pe-tooltip-header"> <h4 class="pe-tooltip-title"></h4> <button class="pe-tooltip-close" aria-label="Close tooltip"> <span class="dashicons dashicons-no-alt"></span> </button> </div> <div class="pe-tooltip-content"> <div class="pe-tooltip-notes"> <h5 class="pe-tooltip-section-title">Notes</h5> <div class="pe-tooltip-notes-content"></div> </div> <div class="pe-tooltip-details"> <h5 class="pe-tooltip-section-title">Details</h5> <div class="pe-tooltip-details-content"></div> </div> </div> </div> </template> `;
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
