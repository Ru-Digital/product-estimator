  ...
  bindEstimateListEventHandlers() {
    ...
    estimatesList._clickHandler = (e) => {
      ...
      if (removeEstimateBtn) {
        logger.log('==== REMOVE ESTIMATE BUTTON CLICKED ====');
        e.preventDefault();
        ...
        logger.log('Remove button details:', {
          button: removeEstimateBtn,
          dataAttributeValue: estimateId,
          hasDataAttribute: removeEstimateBtn.hasAttribute('data-estimate-id'),
